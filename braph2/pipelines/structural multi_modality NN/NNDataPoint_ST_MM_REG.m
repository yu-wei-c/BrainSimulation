classdef NNDataPoint_ST_MM_REG < NNDataPoint
	...
	%  <strong>1</strong> <strong>ELCLASS</strong> 	ELCLASS (constant, string) is the class of the data point for regression with structural multimodality data.
	%  <strong>2</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of a data point for regression with structural multimodality data.
	%  <strong>3</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of a data point for regression with structural multimodality data.
	%  <strong>4</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of a data point for regression with structural multimodality data.
	%  <strong>5</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for a data point for regression with structural multimodality data.
	%  <strong>6</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of a data point for regression with structural multimodality data.
	%  <strong>7</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about a data point for regression with structural multimodality data.
	...
	methods (Static) % inspection
		function build = getBuild()
			%GETBUILD returns the build of the structural multimodality regression data point.
			%
			% BUILD = NNDataPoint_ST_MM_REG.GETBUILD() returns the build of 'NNDataPoint_ST_MM_REG'.
			%
			% Alternative forms to call this method are:
			%  BUILD = DP.GETBUILD() returns the build of the structural multimodality regression data point DP.
			%  BUILD = Element.GETBUILD(DP) returns the build of 'DP'.
			%  BUILD = Element.GETBUILD('NNDataPoint_ST_MM_REG') returns the build of 'NNDataPoint_ST_MM_REG'.
			%
			% Note that the Element.GETBUILD(DP) and Element.GETBUILD('NNDataPoint_ST_MM_REG')
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				nndatapoint_st_mm_reg_tag_list = { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'INPUT'  'TARGET'  'SUB'  'TARGET_IDS' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			nndatapoint_st_mm_reg_category_list = { 1  1  1  3  4  2  2  6  5  5  4  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			nndatapoint_st_mm_reg_format_list = { 2  2  2  8  2  2  2  2  16  16  8  3 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 11 % NNDataPoint_ST_MM_REG.SUB
					prop_settings = 'SubjectST_MP';
				case 12 % NNDataPoint_ST_MM_REG.TARGET_IDS
					prop_settings = Format.getFormatSettings(3);
				case 4 % NNDataPoint_ST_MM_REG.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 1 % NNDataPoint_ST_MM_REG.ELCLASS
					prop_default = 'NNDataPoint_ST_MM_REG';
				case 2 % NNDataPoint_ST_MM_REG.NAME
					prop_default = 'Neural Network Structural Multimodality Data Point for Regression';
				case 3 % NNDataPoint_ST_MM_REG.DESCRIPTION
				...
				case 4 % NNDataPoint_ST_MM_REG.TEMPLATE
					prop_default = Format.getFormatDefault(8, NNDataPoint_ST_MM_REG.getPropSettings(prop));
				case 5 % NNDataPoint_ST_MM_REG.ID
					prop_default = 'NNDataPoint_ST_MM_REG ID';
				case 6 % NNDataPoint_ST_MM_REG.LABEL
					prop_default = 'NNDataPoint_ST_MM_REG label';
				case 7 % NNDataPoint_ST_MM_REG.NOTES
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(dp, prop, varargin)
			...
			switch prop
				case 9 % NNDataPoint_ST_MM_REG.INPUT
				...
				case 10 % NNDataPoint_ST_MM_REG.TARGET
