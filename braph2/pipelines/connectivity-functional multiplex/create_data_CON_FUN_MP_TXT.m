function create_data_CON_FUN_MP_TXT(data_dir, random_seed)
%CREATE_DATA_CON_FUN_MP_TXT creates connectivity-functional data
%
% CREATE_DATA_CON_FUN_MP_TXT() creates connectivity-functional data in default folder 'Example
%  data CON_FUN_MP TXT'.
%
% CREATE_DATA_CON_FUN_MP_TXT(DATA_DIR) creates connectivity-functional data in DATA_DIR folder.
%
% CREATE_DATA_CON_FUN_MP_TXT(DATA_DIR, RANDOM_SEED) cretes connectivity-functional data in
