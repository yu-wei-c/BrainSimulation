classdef AnalyzeEnsemble_CON_FUN_MP_BUT < AnalyzeEnsemble
	%AnalyzeEnsemble_CON_FUN_MP_BUT is an ensemble-based graph analysis using connectivity and functional multiplex data of fixed threshold.
	...
	%
	% AnalyzeEnsemble_CON_FUN_MP_BUT methods:
	...
	%
	% AnalyzeEnsemble_CON_FUN_MP_BUT methods (display):
	%  tostring - string with information about the graph analysis with connectivity and functional multiplex data of fixed threshold
	%  disp - displays information about the graph analysis with connectivity and functional multiplex data of fixed threshold
	%  tree - displays the tree of the graph analysis with connectivity and functional multiplex data of fixed threshold
	%
	% AnalyzeEnsemble_CON_FUN_MP_BUT methods (miscellanea):
	%  getNoValue - returns a pointer to a persistent instance of NoValue
	%               Use it as Element.getNoValue()
	%  getCallback - returns the callback to a property
	%  isequal - determines whether two graph analysis with connectivity and functional multiplex data of fixed threshold are equal (values, locked)
	%  getElementList - returns a list with all subelements
	%  copy - copies the graph analysis with connectivity and functional multiplex data of fixed threshold
	%
	% AnalyzeEnsemble_CON_FUN_MP_BUT methods (save/load, Static):
	%  save - saves BRAPH2 graph analysis with connectivity and functional multiplex data of fixed threshold as b2 file
	%  load - loads a BRAPH2 graph analysis with connectivity and functional multiplex data of fixed threshold from a b2 file
	%
	% AnalyzeEnsemble_CON_FUN_MP_BUT method (JSON encode):
	%  encodeJSON - returns a JSON string encoding the graph analysis with connectivity and functional multiplex data of fixed threshold
	%
	% AnalyzeEnsemble_CON_FUN_MP_BUT method (JSON decode, Static):
	%   decodeJSON - returns a JSON string encoding the graph analysis with connectivity and functional multiplex data of fixed threshold
	%
	% AnalyzeEnsemble_CON_FUN_MP_BUT methods (inspection, Static):
	%  getClass - returns the class of the graph analysis with connectivity and functional multiplex data of fixed threshold
	%  getSubclasses - returns all subclasses of AnalyzeEnsemble_CON_FUN_MP_BUT
	%  getProps - returns the property list of the graph analysis with connectivity and functional multiplex data of fixed threshold
	%  getPropNumber - returns the property number of the graph analysis with connectivity and functional multiplex data of fixed threshold
	...
	%
	% AnalyzeEnsemble_CON_FUN_MP_BUT methods (GUI):
	%  getPanelProp - returns a prop panel
	%
	% AnalyzeEnsemble_CON_FUN_MP_BUT methods (GUI, Static):
	%  getGUIMenuImport - returns the importer menu
	%  getGUIMenuExport - returns the exporter menu
	%
	% AnalyzeEnsemble_CON_FUN_MP_BUT methods (category, Static):
	...
	%
	% AnalyzeEnsemble_CON_FUN_MP_BUT methods (format, Static):
	...
	%
	% To print full list of constants, click here <a href="matlab:metaclass = ?AnalyzeEnsemble_CON_FUN_MP_BUT; properties = metaclass.PropertyList;for i = 1:1:length(properties), if properties(i).Constant, disp([properties(i).Name newline() tostring(properties(i).DefaultValue) newline()]), end, end">AnalyzeEnsemble_CON_FUN_MP_BUT constants</a>.
	%
	%
	...
	methods % constructor
		function a = AnalyzeEnsemble_CON_FUN_MP_BUT(varargin)
			%AnalyzeEnsemble_CON_FUN_MP_BUT() creates a graph analysis with connectivity and functional multiplex data of fixed threshold.
			%
			% AnalyzeEnsemble_CON_FUN_MP_BUT(PROP, VALUE, ...) with property PROP initialized to VALUE.
			%
			% AnalyzeEnsemble_CON_FUN_MP_BUT(TAG, VALUE, ...) with property TAG set to VALUE.
			%
	...
	methods (Static) % inspection
		...
		function a_class = getClass()
			%GETCLASS returns the class of the graph analysis with connectivity and functional multiplex data of fixed threshold.
			%
			% CLASS = AnalyzeEnsemble_CON_FUN_MP_BUT.GETCLASS() returns the class 'AnalyzeEnsemble_CON_FUN_MP_BUT'.
			%
			% Alternative forms to call this method are:
			%  CLASS = A.GETCLASS() returns the class of the graph analysis with connectivity and functional multiplex data of fixed threshold A.
			%  CLASS = Element.GETCLASS(A) returns the class of 'A'.
			%  CLASS = Element.GETCLASS('AnalyzeEnsemble_CON_FUN_MP_BUT') returns 'AnalyzeEnsemble_CON_FUN_MP_BUT'.
			%
			% Note that the Element.GETCLASS(A) and Element.GETCLASS('AnalyzeEnsemble_CON_FUN_MP_BUT')
			%  are less computationally efficient.
			
			a_class = 'AnalyzeEnsemble_CON_FUN_MP_BUT';
		end
		function subclass_list = getSubclasses()
			%GETSUBCLASSES returns all subclasses of the graph analysis with connectivity and functional multiplex data of fixed threshold.
			%
			% LIST = AnalyzeEnsemble_CON_FUN_MP_BUT.GETSUBCLASSES() returns all subclasses of 'AnalyzeEnsemble_CON_FUN_MP_BUT'.
			%
			% Alternative forms to call this method are:
			%  LIST = A.GETSUBCLASSES() returns all subclasses of the graph analysis with connectivity and functional multiplex data of fixed threshold A.
			%  LIST = Element.GETSUBCLASSES(A) returns all subclasses of 'A'.
			%  LIST = Element.GETSUBCLASSES('AnalyzeEnsemble_CON_FUN_MP_BUT') returns all subclasses of 'AnalyzeEnsemble_CON_FUN_MP_BUT'.
			%
			% Note that the Element.GETSUBCLASSES(A) and Element.GETSUBCLASSES('AnalyzeEnsemble_CON_FUN_MP_BUT')
			%  are less computationally efficient.
			%
			% See also subclasses.
		...
		function prop_list = getProps(category)
			...
			%
			% PROPS = AnalyzeEnsemble_CON_FUN_MP_BUT.GETPROPS() returns the property list of graph analysis with connectivity and functional multiplex data of fixed threshold
			%  as a row vector.
			%
			% PROPS = AnalyzeEnsemble_CON_FUN_MP_BUT.GETPROPS(CATEGORY) returns the property list 
			%  of category CATEGORY.
			%
			% Alternative forms to call this method are:
			%  PROPS = A.GETPROPS([CATEGORY]) returns the property list of the graph analysis with connectivity and functional multiplex data of fixed threshold A.
			%  PROPS = Element.GETPROPS(A[, CATEGORY]) returns the property list of 'A'.
			%  PROPS = Element.GETPROPS('AnalyzeEnsemble_CON_FUN_MP_BUT'[, CATEGORY]) returns the property list of 'AnalyzeEnsemble_CON_FUN_MP_BUT'.
			%
			% Note that the Element.GETPROPS(A) and Element.GETPROPS('AnalyzeEnsemble_CON_FUN_MP_BUT')
			%  are less computationally efficient.
			%
		...
		function prop_number = getPropNumber(varargin)
			%GETPROPNUMBER returns the property number of graph analysis with connectivity and functional multiplex data of fixed threshold.
			%
			% N = AnalyzeEnsemble_CON_FUN_MP_BUT.GETPROPNUMBER() returns the property number of graph analysis with connectivity and functional multiplex data of fixed threshold.
			%
			% N = AnalyzeEnsemble_CON_FUN_MP_BUT.GETPROPNUMBER(CATEGORY) returns the property number of graph analysis with connectivity and functional multiplex data of fixed threshold
			%  of category CATEGORY
			%
			% Alternative forms to call this method are:
			%  N = A.GETPROPNUMBER([CATEGORY]) returns the property number of the graph analysis with connectivity and functional multiplex data of fixed threshold A.
			%  N = Element.GETPROPNUMBER(A) returns the property number of 'A'.
			%  N = Element.GETPROPNUMBER('AnalyzeEnsemble_CON_FUN_MP_BUT') returns the property number of 'AnalyzeEnsemble_CON_FUN_MP_BUT'.
			%
			% Note that the Element.GETPROPNUMBER(A) and Element.GETPROPNUMBER('AnalyzeEnsemble_CON_FUN_MP_BUT')
			%  are less computationally efficient.
			%
		...
		function check_out = existsProp(prop)
			...
			%
			% CHECK = AnalyzeEnsemble_CON_FUN_MP_BUT.EXISTSPROP(PROP) checks whether the property PROP exists.
			%
			% Alternative forms to call this method are:
			%  CHECK = A.EXISTSPROP(PROP) checks whether PROP exists for A.
			%  CHECK = Element.EXISTSPROP(A, PROP) checks whether PROP exists for A.
			%  CHECK = Element.EXISTSPROP(AnalyzeEnsemble_CON_FUN_MP_BUT, PROP) checks whether PROP exists for AnalyzeEnsemble_CON_FUN_MP_BUT.
			%
			...
			%   Error id: [BRAPH2:AnalyzeEnsemble_CON_FUN_MP_BUT:WrongInput]
			%  Element.EXISTSPROP(AnalyzeEnsemble_CON_FUN_MP_BUT, PROP) throws error if PROP does NOT exist for AnalyzeEnsemble_CON_FUN_MP_BUT.
			%   Error id: [BRAPH2:AnalyzeEnsemble_CON_FUN_MP_BUT:WrongInput]
			%
			% Note that the Element.EXISTSPROP(A) and Element.EXISTSPROP('AnalyzeEnsemble_CON_FUN_MP_BUT')
			%  are less computationally efficient.
			%
		...
		function check_out = existsTag(tag)
			%EXISTSTAG checks whether tag exists in graph analysis with connectivity and functional multiplex data of fixed threshold/error.
			%
			% CHECK = AnalyzeEnsemble_CON_FUN_MP_BUT.EXISTSTAG(TAG) checks whether a property with tag TAG exists.
			%
			% Alternative forms to call this method are:
			%  CHECK = A.EXISTSTAG(TAG) checks whether TAG exists for A.
			%  CHECK = Element.EXISTSTAG(A, TAG) checks whether TAG exists for A.
			%  CHECK = Element.EXISTSTAG(AnalyzeEnsemble_CON_FUN_MP_BUT, TAG) checks whether TAG exists for AnalyzeEnsemble_CON_FUN_MP_BUT.
			%
			...
			%   Error id: [BRAPH2:AnalyzeEnsemble_CON_FUN_MP_BUT:WrongInput]
			%  Element.EXISTSTAG(AnalyzeEnsemble_CON_FUN_MP_BUT, TAG) throws error if TAG does NOT exist for AnalyzeEnsemble_CON_FUN_MP_BUT.
			%   Error id: [BRAPH2:AnalyzeEnsemble_CON_FUN_MP_BUT:WrongInput]
			%
			% Note that the Element.EXISTSTAG(A) and Element.EXISTSTAG('AnalyzeEnsemble_CON_FUN_MP_BUT')
			%  are less computationally efficient.
			%
			% See also getProps, existsTag.
		...
		function prop = getPropProp(pointer)
			...
			%  PROPERTY = Element.GETPROPPROP(AnalyzeEnsemble_CON_FUN_MP_BUT, POINTER) returns property number of POINTER of AnalyzeEnsemble_CON_FUN_MP_BUT.
			%  PROPERTY = A.GETPROPPROP(AnalyzeEnsemble_CON_FUN_MP_BUT, POINTER) returns property number of POINTER of AnalyzeEnsemble_CON_FUN_MP_BUT.
			%
			% Note that the Element.GETPROPPROP(A) and Element.GETPROPPROP('AnalyzeEnsemble_CON_FUN_MP_BUT')
			%  are less computationally efficient.
			%
		...
		function tag = getPropTag(pointer)
			...
			%  TAG = Element.GETPROPTAG(AnalyzeEnsemble_CON_FUN_MP_BUT, POINTER) returns tag of POINTER of AnalyzeEnsemble_CON_FUN_MP_BUT.
			%  TAG = A.GETPROPTAG(AnalyzeEnsemble_CON_FUN_MP_BUT, POINTER) returns tag of POINTER of AnalyzeEnsemble_CON_FUN_MP_BUT.
			%
			% Note that the Element.GETPROPTAG(A) and Element.GETPROPTAG('AnalyzeEnsemble_CON_FUN_MP_BUT')
			%  are less computationally efficient.
			%
		...
		function prop_category = getPropCategory(pointer)
			...
			%  CATEGORY = Element.GETPROPCATEGORY(AnalyzeEnsemble_CON_FUN_MP_BUT, POINTER) returns category of POINTER of AnalyzeEnsemble_CON_FUN_MP_BUT.
			%  CATEGORY = A.GETPROPCATEGORY(AnalyzeEnsemble_CON_FUN_MP_BUT, POINTER) returns category of POINTER of AnalyzeEnsemble_CON_FUN_MP_BUT.
			%
			% Note that the Element.GETPROPCATEGORY(A) and Element.GETPROPCATEGORY('AnalyzeEnsemble_CON_FUN_MP_BUT')
			%  are less computationally efficient.
			%
		...
		function prop_format = getPropFormat(pointer)
			...
			%  FORMAT = Element.GETPROPFORMAT(AnalyzeEnsemble_CON_FUN_MP_BUT, POINTER) returns format of POINTER of AnalyzeEnsemble_CON_FUN_MP_BUT.
			%  FORMAT = A.GETPROPFORMAT(AnalyzeEnsemble_CON_FUN_MP_BUT, POINTER) returns format of POINTER of AnalyzeEnsemble_CON_FUN_MP_BUT.
			%
			% Note that the Element.GETPROPFORMAT(A) and Element.GETPROPFORMAT('AnalyzeEnsemble_CON_FUN_MP_BUT')
			%  are less computationally efficient.
			%
		...
		function prop_description = getPropDescription(pointer)
			...
			%  DESCRIPTION = Element.GETPROPDESCRIPTION(AnalyzeEnsemble_CON_FUN_MP_BUT, POINTER) returns description of POINTER of AnalyzeEnsemble_CON_FUN_MP_BUT.
			%  DESCRIPTION = A.GETPROPDESCRIPTION(AnalyzeEnsemble_CON_FUN_MP_BUT, POINTER) returns description of POINTER of AnalyzeEnsemble_CON_FUN_MP_BUT.
			%
			% Note that the Element.GETPROPDESCRIPTION(A) and Element.GETPROPDESCRIPTION('AnalyzeEnsemble_CON_FUN_MP_BUT')
			%  are less computationally efficient.
			%
		...
		function prop_settings = getPropSettings(pointer)
			...
			%  SETTINGS = Element.GETPROPSETTINGS(AnalyzeEnsemble_CON_FUN_MP_BUT, POINTER) returns settings of POINTER of AnalyzeEnsemble_CON_FUN_MP_BUT.
			%  SETTINGS = A.GETPROPSETTINGS(AnalyzeEnsemble_CON_FUN_MP_BUT, POINTER) returns settings of POINTER of AnalyzeEnsemble_CON_FUN_MP_BUT.
			%
			% Note that the Element.GETPROPSETTINGS(A) and Element.GETPROPSETTINGS('AnalyzeEnsemble_CON_FUN_MP_BUT')
			%  are less computationally efficient.
			%
		...
		function prop_default = getPropDefault(pointer)
			%GETPROPDEFAULT returns the default value of a property.
			%
			% DEFAULT = AnalyzeEnsemble_CON_FUN_MP_BUT.GETPROPDEFAULT(PROP) returns the default 
			%  value of the property PROP.
			%
			% DEFAULT = AnalyzeEnsemble_CON_FUN_MP_BUT.GETPROPDEFAULT(TAG) returns the default 
			%  value of the property with tag TAG.
			%
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			%  DEFAULT = A.GETPROPDEFAULT(POINTER) returns the default value of POINTER of A.
			%  DEFAULT = Element.GETPROPDEFAULT(AnalyzeEnsemble_CON_FUN_MP_BUT, POINTER) returns the default value of POINTER of AnalyzeEnsemble_CON_FUN_MP_BUT.
			%  DEFAULT = A.GETPROPDEFAULT(AnalyzeEnsemble_CON_FUN_MP_BUT, POINTER) returns the default value of POINTER of AnalyzeEnsemble_CON_FUN_MP_BUT.
			%
			% Note that the Element.GETPROPDEFAULT(A) and Element.GETPROPDEFAULT('AnalyzeEnsemble_CON_FUN_MP_BUT')
			%  are less computationally efficient.
			%
		...
		function prop_default = getPropDefaultConditioned(pointer)
			%GETPROPDEFAULTCONDITIONED returns the conditioned default value of a property.
			%
			% DEFAULT = AnalyzeEnsemble_CON_FUN_MP_BUT.GETPROPDEFAULTCONDITIONED(PROP) returns the conditioned default 
			%  value of the property PROP.
			%
			% DEFAULT = AnalyzeEnsemble_CON_FUN_MP_BUT.GETPROPDEFAULTCONDITIONED(TAG) returns the conditioned default 
			%  value of the property with tag TAG.
			%
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			%  DEFAULT = A.GETPROPDEFAULTCONDITIONED(POINTER) returns the conditioned default value of POINTER of A.
			%  DEFAULT = Element.GETPROPDEFAULTCONDITIONED(AnalyzeEnsemble_CON_FUN_MP_BUT, POINTER) returns the conditioned default value of POINTER of AnalyzeEnsemble_CON_FUN_MP_BUT.
			%  DEFAULT = A.GETPROPDEFAULTCONDITIONED(AnalyzeEnsemble_CON_FUN_MP_BUT, POINTER) returns the conditioned default value of POINTER of AnalyzeEnsemble_CON_FUN_MP_BUT.
			%
			% Note that the Element.GETPROPDEFAULTCONDITIONED(A) and Element.GETPROPDEFAULTCONDITIONED('AnalyzeEnsemble_CON_FUN_MP_BUT')
			%  are less computationally efficient.
			%
			...
			prop_default = AnalyzeEnsemble_CON_FUN_MP_BUT.conditioning(prop, AnalyzeEnsemble_CON_FUN_MP_BUT.getPropDefault(prop));
		end
	end
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			%  CHECK = Element.CHECKPROP(AnalyzeEnsemble_CON_FUN_MP_BUT, PROP, VALUE) checks VALUE format for PROP of AnalyzeEnsemble_CON_FUN_MP_BUT.
			%  CHECK = A.CHECKPROP(AnalyzeEnsemble_CON_FUN_MP_BUT, PROP, VALUE) checks VALUE format for PROP of AnalyzeEnsemble_CON_FUN_MP_BUT.
			% 
