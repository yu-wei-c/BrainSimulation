function create_data_CON_XLS(data_dir, random_seed)
%CREATE_DATA_CON_XLS creates connectivity data
%
% CREATE_DATA_CON_XLS() creates connectivity data in default folder 'Example
%  data CON XLS'.
%
% CREATE_DATA_CON_XLS(DATA_DIR) creates connectivity data in DATA_DIR folder.
%
