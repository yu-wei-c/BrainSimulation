function create_data_FUN_XLS(data_dir, random_seed)
%CREATE_DATA_FUN_XLS creates functional data
%
% CREATE_DATA_FUN_XLS() creates functional data in default folder 'Example
%  data ST XLS'.
%
% CREATE_DATA_FUN_XLS(DATA_DIR) creates functional data in DATA_DIR folder.
%
% CREATE_DATA_FUN_XLS(DATA_DIR, RANDOM_SEED) cretes functional data in DATA_DIR
