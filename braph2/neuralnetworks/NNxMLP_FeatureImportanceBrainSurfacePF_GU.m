classdef NNxMLP_FeatureImportanceBrainSurfacePF_GU < NNxMLP_FeatureImportanceBrainSurfacePF
	...
	%
	% The list of NNxMLP_FeatureImportanceBrainSurfacePF_GU properties is:
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'NNxMLP_FeatureImportanceBrainSurfacePF_GU' }; %CET: Computational Efficiency Trick
		end
		...
		function check_out = existsProp(prop)
			...
			elseif ~check
				error( ...
					['BRAPH2' ':NNxMLP_FeatureImportanceBrainSurfacePF_GU:' 'WrongInput'], ...
					['BRAPH2' ':NNxMLP_FeatureImportanceBrainSurfacePF_GU:' 'WrongInput' '\n' ...
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				nnxmlp_featureimportancebrainsurfacepf_gu_tag_list = { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'ST_POSITION'  'H_TOOLBAR'  'H_TOOLS'  'H_AXES'  'VIEW'  'ST_AXIS'  'LISTENER_ST_AXIS'  'SURFFILE'  'SURF'  'H_BRAIN'  'BRAIN'  'ST_SURFACE'  'ST_AMBIENT'  'BA'  'H_SPHS'  'SPHS'  'SPH_DICT'  'H_SYMS'  'SYMS'  'SYM_DICT'  'H_IDS'  'IDS'  'ID_DICT'  'H_LABS'  'LABS'  'LAB_DICT'  'FI'  'D'  'SETUP' };
				tag = nnxmlp_featureimportancebrainsurfacepf_gu_tag_list{pointer}; % prop = pointer
			end
		end
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			nnxmlp_featureimportancebrainsurfacepf_gu_category_list = { 1  1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  8  7  7  7  8  8  7  8  2  7  8  8  8  2  7  8  8  7  8  8  7  8  8  7  8  8  2  2  6 };
			prop_category = nnxmlp_featureimportancebrainsurfacepf_gu_category_list{prop};
		end
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			nnxmlp_featureimportancebrainsurfacepf_gu_format_list = { 2  2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  8  18  19  18  12  8  18  5  8  18  4  8  8  8  19  4  10  19  4  10  19  4  10  19  4  10  16  8  1 };
			prop_format = nnxmlp_featureimportancebrainsurfacepf_gu_format_list{prop};
		end
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 4 % NNxMLP_FeatureImportanceBrainSurfacePF_GU.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 1 % NNxMLP_FeatureImportanceBrainSurfacePF_GU.ELCLASS
					prop_default = 'NNxMLP_FeatureImportanceBrainSurfacePF_GU';
				case 2 % NNxMLP_FeatureImportanceBrainSurfacePF_GU.NAME
					prop_default = 'Panel Figure for Measure Group Brain';
				case 3 % NNxMLP_FeatureImportanceBrainSurfacePF_GU.DESCRIPTION
				...
				case 4 % NNxMLP_FeatureImportanceBrainSurfacePF_GU.TEMPLATE
					prop_default = Format.getFormatDefault(8, NNxMLP_FeatureImportanceBrainSurfacePF_GU.getPropSettings(prop));
				case 5 % NNxMLP_FeatureImportanceBrainSurfacePF_GU.ID
					prop_default = 'NNxMLP_FeatureImportanceBrainSurfacePF_GU ID';
				case 6 % NNxMLP_FeatureImportanceBrainSurfacePF_GU.LABEL
					prop_default = 'NNxMLP_FeatureImportanceBrainSurfacePF_GU label';
				case 7 % NNxMLP_FeatureImportanceBrainSurfacePF_GU.NOTES
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				case 4 % NNxMLP_FeatureImportanceBrainSurfacePF_GU.TEMPLATE
					check = Format.checkFormat(8, value, NNxMLP_FeatureImportanceBrainSurfacePF_GU.getPropSettings(prop));
				otherwise
					if prop <= 48
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pf, prop, varargin)
			...
			switch prop
				case 11 % NNxMLP_FeatureImportanceBrainSurfacePF_GU.DRAW
				...
				case 18 % NNxMLP_FeatureImportanceBrainSurfacePF_GU.DELETE
					value = calculateValue@BrainAtlasPF(pf, 18, varargin{:}); % also warning
					if value
					    % do nothing
					end
					
				case 48 % NNxMLP_FeatureImportanceBrainSurfacePF_GU.SETUP
					warning([BRAPH2.STR ':NNxMLP_FeatureImportanceBrainSurfacePF_GU'], [BRAPH2.STR ':NNxMLP_FeatureImportanceBrainSurfacePF_GU \nThis functionality is not implemented yet.\nYou can contact the BRAPH2 developers and ask for it, \nor, even better, implement it yourself and share it with the community!'])
					value = [];
