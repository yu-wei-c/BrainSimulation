classdef NNxMLP_FeatureImportanceBrainSurfacePF_NS < NNxMLP_FeatureImportanceBrainSurfacePF
	...
	%
	% The list of NNxMLP_FeatureImportanceBrainSurfacePF_NS properties is:
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'NNxMLP_FeatureImportanceBrainSurfacePF_NS' }; %CET: Computational Efficiency Trick
		end
		...
		function check_out = existsProp(prop)
			...
			elseif ~check
				error( ...
					['BRAPH2' ':NNxMLP_FeatureImportanceBrainSurfacePF_NS:' 'WrongInput'], ...
					['BRAPH2' ':NNxMLP_FeatureImportanceBrainSurfacePF_NS:' 'WrongInput' '\n' ...
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			nnxmlp_featureimportancebrainsurfacepf_ns_category_list = { 1  1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  8  7  7  7  8  8  7  8  2  7  8  8  8  2  7  8  8  7  8  8  7  8  8  7  8  8  2  2  6  8  8  8  8 };
			prop_category = nnxmlp_featureimportancebrainsurfacepf_ns_category_list{prop};
		end
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			nnxmlp_featureimportancebrainsurfacepf_ns_format_list = { 2  2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  8  18  19  18  12  8  18  5  8  18  4  8  8  8  19  4  10  19  4  10  19  4  10  19  4  10  16  8  1  11  5  11  5 };
			prop_format = nnxmlp_featureimportancebrainsurfacepf_ns_format_list{prop};
		end
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 49 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.LAYER
					prop_settings = Format.getFormatSettings(11);
				case 50 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.SIZE_DIFF
					prop_settings = {'on' 'off' 'disable'};
				case 51 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.SIZE_SCALE
					prop_settings = Format.getFormatSettings(11);
				case 52 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.COLOR_DIFF
					prop_settings = {'on' 'off' 'disable'};
				case 4 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 52 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.COLOR_DIFF
					prop_default = 'on';
				case 1 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.ELCLASS
					prop_default = 'NNxMLP_FeatureImportanceBrainSurfacePF_NS';
				case 2 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.NAME
					prop_default = 'NNxMLP_FeatureImportanceBrainSurfacePF_NS';
				case 3 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.DESCRIPTION
				...
				case 4 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.TEMPLATE
					prop_default = Format.getFormatDefault(8, NNxMLP_FeatureImportanceBrainSurfacePF_NS.getPropSettings(prop));
				case 5 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.ID
					prop_default = 'NNxMLP_FeatureImportanceBrainSurfacePF_NS ID';
				case 6 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.LABEL
					prop_default = 'NNxMLP_FeatureImportanceBrainSurfacePF_NS label';
				case 7 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.NOTES
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				case 49 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.LAYER
					check = Format.checkFormat(11, value, NNxMLP_FeatureImportanceBrainSurfacePF_NS.getPropSettings(prop));
				case 50 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.SIZE_DIFF
					check = Format.checkFormat(5, value, NNxMLP_FeatureImportanceBrainSurfacePF_NS.getPropSettings(prop));
				case 51 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.SIZE_SCALE
					check = Format.checkFormat(11, value, NNxMLP_FeatureImportanceBrainSurfacePF_NS.getPropSettings(prop));
				case 52 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.COLOR_DIFF
					check = Format.checkFormat(5, value, NNxMLP_FeatureImportanceBrainSurfacePF_NS.getPropSettings(prop));
				case 4 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.TEMPLATE
					check = Format.checkFormat(8, value, NNxMLP_FeatureImportanceBrainSurfacePF_NS.getPropSettings(prop));
				otherwise
					if prop <= 48
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pf, prop, varargin)
			...
			switch prop
				case 48 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.SETUP
	...
	methods % GUI
		function pr = getPanelProp(pf, prop, varargin)
			...
			switch prop
				case 49 % NNxMLP_FeatureImportanceBrainSurfacePF_NS.LAYER
					pr = NNxMLP_FeatureImportanceBSPF_xSPP_Layer('EL', pf, 'PROP', 49);
