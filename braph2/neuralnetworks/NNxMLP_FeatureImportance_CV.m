classdef NNxMLP_FeatureImportance_CV < ConcreteElement
	...
	methods (Static) % inspection
		function build = getBuild()
			...
			%
			% BUILD = NNxMLP_FeatureImportance_CV.GETBUILD() returns the build of 'NNxMLP_FeatureImportance_CV'.
			%
			...
			%  BUILD = Element.GETBUILD('NNxMLP_FeatureImportance_CV') returns the build of 'NNxMLP_FeatureImportance_CV'.
			%
			% Note that the Element.GETBUILD(NNFICV) and Element.GETBUILD('NNxMLP_FeatureImportance_CV')
