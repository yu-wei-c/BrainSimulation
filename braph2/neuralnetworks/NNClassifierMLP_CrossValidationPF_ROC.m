classdef NNClassifierMLP_CrossValidationPF_ROC < PanelFig
	...
	methods (Static) % inspection
		function build = getBuild()
			...
			%
			% BUILD = NNClassifierMLP_CrossValidationPF_ROC.GETBUILD() returns the build of 'NNClassifierMLP_CrossValidationPF_ROC'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PF.GETBUILD() returns the build of the panel receiver operating characteristic figure PF.
			%  BUILD = Element.GETBUILD(PF) returns the build of 'PF'.
			%  BUILD = Element.GETBUILD('NNClassifierMLP_CrossValidationPF_ROC') returns the build of 'NNClassifierMLP_CrossValidationPF_ROC'.
			%
			% Note that the Element.GETBUILD(PF) and Element.GETBUILD('NNClassifierMLP_CrossValidationPF_ROC')
