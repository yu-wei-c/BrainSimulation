classdef MeasurePF_GU < MeasurePF
	...
	methods (Static) % inspection
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 40 % MeasurePF_GU.LAYER
					prop_settings = Format.getFormatSettings(11);
				case 4 % MeasurePF_GU.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 40 % MeasurePF_GU.LAYER
					prop_default = 1;
				case 1 % MeasurePF_GU.ELCLASS
					prop_default = 'MeasurePF_GU';
				case 2 % MeasurePF_GU.NAME
					prop_default = 'Panel Figure for Global Unilayer Measure';
				case 3 % MeasurePF_GU.DESCRIPTION
				...
				case 5 % MeasurePF_GU.ID
					prop_default = 'MeasurePF_GU ID';
				case 6 % MeasurePF_GU.LABEL
					prop_default = 'MeasurePF_GU label';
				case 7 % MeasurePF_GU.NOTES
	...
	methods % GUI
		function pr = getPanelProp(pf, prop, varargin)
			...
			switch prop
				case 40 % MeasurePF_GU.LAYER
					pr = MeasurePF_xUPP_Layer('EL', pf, 'PROP', 40);
