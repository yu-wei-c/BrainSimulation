	...
	methods (Static) % inspection
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 36 % MeasurePF_BxPP_Nodes.DROPDOWN_NODE1
					prop_settings = Format.getFormatSettings(18);
				case 37 % MeasurePF_BxPP_Nodes.DROPDOWN_NODE2
					prop_settings = Format.getFormatSettings(18);
				case 4 % MeasurePF_BxPP_Nodes.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 37 % MeasurePF_BxPP_Nodes.DROPDOWN_NODE2
					prop_default = Format.getFormatDefault(18, MeasurePF_BxPP_Nodes.getPropSettings(prop));
				case 1 % MeasurePF_BxPP_Nodes.ELCLASS
					prop_default = 'MeasurePF_BxPP_Nodes';
				case 2 % MeasurePF_BxPP_Nodes.NAME
					prop_default = 'Nodes Prop Panel';
				case 3 % MeasurePF_BxPP_Nodes.DESCRIPTION
				...
				case 5 % MeasurePF_BxPP_Nodes.ID
					prop_default = 'MeasurePF_BxPP_Nodes ID';
				case 6 % MeasurePF_BxPP_Nodes.LABEL
					prop_default = 'MeasurePF_BxPP_Nodes label';
				case 7 % MeasurePF_BxPP_Nodes.NOTES
					prop_default = 'MeasurePF_BxPP_Nodes notes';
				case 23 % MeasurePF_BxPP_Nodes.EL
					prop_default = MeasurePF_BU();
				case 24 % MeasurePF_BxPP_Nodes.PROP
					prop_default = 40;
				case 25 % MeasurePF_BxPP_Nodes.HEIGHT
					prop_default = 48;
				otherwise
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pr, prop, varargin)
			...
			switch prop
				...
				case 20 % MeasurePF_BxPP_Nodes.X_DRAW
				...
				case 21 % MeasurePF_BxPP_Nodes.UPDATE
				...
				case 22 % MeasurePF_BxPP_Nodes.REDRAW
				...
				case 18 % MeasurePF_BxPP_Nodes.DELETE
