classdef MeasureGroupBrainPF_NB < MeasureGroupBrainPF
	...
	%
	% The list of MeasureGroupBrainPF_NB properties is:
	...
	methods (Static) % inspection
		function build = getBuild()
			...
			%
			% BUILD = MeasureGroupBrainPF_NB.GETBUILD() returns the build of 'MeasureGroupBrainPF_NB'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PF.GETBUILD() returns the build of the panel figure for nodal bilayer measure group brain PF.
			%  BUILD = Element.GETBUILD(PF) returns the build of 'PF'.
			%  BUILD = Element.GETBUILD('MeasureGroupBrainPF_NB') returns the build of 'MeasureGroupBrainPF_NB'.
			%
			% Note that the Element.GETBUILD(PF) and Element.GETBUILD('MeasureGroupBrainPF_NB')
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'MeasureGroupBrainPF_NB' }; %CET: Computational Efficiency Trick
		end
		...
		function check_out = existsProp(prop)
			...
			elseif ~check
				error( ...
					['BRAPH2' ':MeasureGroupBrainPF_NB:' 'WrongInput'], ...
					['BRAPH2' ':MeasureGroupBrainPF_NB:' 'WrongInput' '\n' ...
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				measuregroupbrainpf_nb_tag_list = { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'ST_POSITION'  'H_TOOLBAR'  'H_TOOLS'  'H_AXES'  'VIEW'  'ST_AXIS'  'LISTENER_ST_AXIS'  'SURFFILE'  'SURF'  'H_BRAIN'  'BRAIN'  'ST_SURFACE'  'ST_AMBIENT'  'BA'  'H_SPHS'  'SPHS'  'SPH_DICT'  'H_SYMS'  'SYMS'  'SYM_DICT'  'H_IDS'  'IDS'  'ID_DICT'  'H_LABS'  'LABS'  'LAB_DICT'  'M'  'SETUP' };
				tag = measuregroupbrainpf_nb_tag_list{pointer}; % prop = pointer
			end
		end
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			measuregroupbrainpf_nb_category_list = { 1  1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  8  7  7  7  8  8  7  8  2  7  8  8  8  2  7  8  8  7  8  8  7  8  8  7  8  8  2  6 };
			prop_category = measuregroupbrainpf_nb_category_list{prop};
		end
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			measuregroupbrainpf_nb_format_list = { 2  2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  8  18  19  18  12  8  18  5  8  18  4  8  8  8  19  4  10  19  4  10  19  4  10  19  4  10  8  1 };
			prop_format = measuregroupbrainpf_nb_format_list{prop};
		end
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 4 % MeasureGroupBrainPF_NB.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 1 % MeasureGroupBrainPF_NB.ELCLASS
					prop_default = 'MeasureGroupBrainPF_NB';
				case 2 % MeasureGroupBrainPF_NB.NAME
					prop_default = 'Panel Figure for Measure Group Brain';
				case 3 % MeasureGroupBrainPF_NB.DESCRIPTION
				...
				case 4 % MeasureGroupBrainPF_NB.TEMPLATE
					prop_default = Format.getFormatDefault(8, MeasureGroupBrainPF_NB.getPropSettings(prop));
				case 5 % MeasureGroupBrainPF_NB.ID
					prop_default = 'MeasureGroupBrainPF_NB ID';
				case 6 % MeasureGroupBrainPF_NB.LABEL
					prop_default = 'MeasureGroupBrainPF_NB label';
				case 7 % MeasureGroupBrainPF_NB.NOTES
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				case 4 % MeasureGroupBrainPF_NB.TEMPLATE
					check = Format.checkFormat(8, value, MeasureGroupBrainPF_NB.getPropSettings(prop));
				otherwise
					if prop <= 47
