classdef MeasureEnsembleBrainPF_GS < MeasureEnsembleBrainPF
	...
	%
	% The list of MeasureEnsembleBrainPF_GS properties is:
	...
	methods (Static) % inspection
		function build = getBuild()
			%GETBUILD returns the build of the panel figure for global superglobal measure group brain.
			%
			% BUILD = MeasureEnsembleBrainPF_GS.GETBUILD() returns the build of 'MeasureEnsembleBrainPF_GS'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PF.GETBUILD() returns the build of the panel figure for global superglobal measure group brain PF.
			%  BUILD = Element.GETBUILD(PF) returns the build of 'PF'.
			%  BUILD = Element.GETBUILD('MeasureEnsembleBrainPF_GS') returns the build of 'MeasureEnsembleBrainPF_GS'.
			%
			% Note that the Element.GETBUILD(PF) and Element.GETBUILD('MeasureEnsembleBrainPF_GS')
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'MeasureEnsembleBrainPF_GS' }; %CET: Computational Efficiency Trick
		end
		...
		function check_out = existsProp(prop)
			...
			elseif ~check
				error( ...
					['BRAPH2' ':MeasureEnsembleBrainPF_GS:' 'WrongInput'], ...
					['BRAPH2' ':MeasureEnsembleBrainPF_GS:' 'WrongInput' '\n' ...
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			measureensemblebrainpf_gs_category_list = { 1  1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  8  7  7  7  8  8  7  8  2  7  8  8  8  2  7  8  8  7  8  8  7  8  8  7  8  8  2  6 };
			prop_category = measureensemblebrainpf_gs_category_list{prop};
		end
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			measureensemblebrainpf_gs_format_list = { 2  2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  8  18  19  18  12  8  18  5  8  18  4  8  8  8  19  4  10  19  4  10  19  4  10  19  4  10  8  1 };
			prop_format = measureensemblebrainpf_gs_format_list{prop};
		end
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 4 % MeasureEnsembleBrainPF_GS.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 1 % MeasureEnsembleBrainPF_GS.ELCLASS
					prop_default = 'MeasureEnsembleBrainPF_GS';
				case 2 % MeasureEnsembleBrainPF_GS.NAME
					prop_default = 'Panel Figure for Measure Group Brain';
				case 3 % MeasureEnsembleBrainPF_GS.DESCRIPTION
				...
				case 4 % MeasureEnsembleBrainPF_GS.TEMPLATE
					prop_default = Format.getFormatDefault(8, MeasureEnsembleBrainPF_GS.getPropSettings(prop));
				case 5 % MeasureEnsembleBrainPF_GS.ID
					prop_default = 'MeasureEnsembleBrainPF_GS ID';
				case 6 % MeasureEnsembleBrainPF_GS.LABEL
					prop_default = 'MeasureEnsembleBrainPF_GS label';
				case 7 % MeasureEnsembleBrainPF_GS.NOTES
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				case 4 % MeasureEnsembleBrainPF_GS.TEMPLATE
					check = Format.checkFormat(8, value, MeasureEnsembleBrainPF_GS.getPropSettings(prop));
				otherwise
					if prop <= 47
