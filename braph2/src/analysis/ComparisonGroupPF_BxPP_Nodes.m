classdef ComparisonGroupPF_BxPP_Nodes < PanelProp
	...
	methods (Static) % inspection
		function build = getBuild()
			...
			%
			% BUILD = ComparisonGroupPF_BxPP_Nodes.GETBUILD() returns the build of 'ComparisonGroupPF_BxPP_Nodes'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PR.GETBUILD() returns the build of the panel property node PR.
			%  BUILD = Element.GETBUILD(PR) returns the build of 'PR'.
			%  BUILD = Element.GETBUILD('ComparisonGroupPF_BxPP_Nodes') returns the build of 'ComparisonGroupPF_BxPP_Nodes'.
			%
			% Note that the Element.GETBUILD(PR) and Element.GETBUILD('ComparisonGroupPF_BxPP_Nodes')
