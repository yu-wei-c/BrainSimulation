classdef MeasureEnsemblePF_BB < MeasureEnsemblePF
	...
	%
	% The list of MeasureEnsemblePF_BB properties is:
	...
	methods (Static) % inspection
		function build = getBuild()
			...
			%
			% BUILD = MeasureEnsemblePF_BB.GETBUILD() returns the build of 'MeasureEnsemblePF_BB'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PF.GETBUILD() returns the build of the panel binodal bilayer group comparison figure PF.
			%  BUILD = Element.GETBUILD(PF) returns the build of 'PF'.
			%  BUILD = Element.GETBUILD('MeasureEnsemblePF_BB') returns the build of 'MeasureEnsemblePF_BB'.
			%
			% Note that the Element.GETBUILD(PF) and Element.GETBUILD('MeasureEnsemblePF_BB')
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'MeasureEnsemblePF_BB' }; %CET: Computational Efficiency Trick
		end
		...
		function check_out = existsProp(prop)
			...
			elseif ~check
				error( ...
					['BRAPH2' ':MeasureEnsemblePF_BB:' 'WrongInput'], ...
					['BRAPH2' ':MeasureEnsemblePF_BB:' 'WrongInput' '\n' ...
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			measureensemblepf_bb_category_list = { 1  1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  8  7  7  7  8  7  2  6  7  8  7  7  8  7  7  8  7  8  7  8  8 };
			prop_category = measureensemblepf_bb_category_list{prop};
		end
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			measureensemblepf_bb_format_list = { 2  2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  8  18  19  18  8  18  8  1  18  8  18  18  8  18  18  8  18  8  18  8  12 };
			prop_format = measureensemblepf_bb_format_list{prop};
		end
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 40 % MeasureEnsemblePF_BB.NODES
					prop_settings = Format.getFormatSettings(12);
				case 4 % MeasureEnsemblePF_BB.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 40 % MeasureEnsemblePF_BB.NODES
					prop_default = Format.getFormatDefault(12, MeasureEnsemblePF_BB.getPropSettings(prop));
				case 1 % MeasureEnsemblePF_BB.ELCLASS
					prop_default = 'MeasureEnsemblePF_BB';
				case 2 % MeasureEnsemblePF_BB.NAME
					prop_default = 'MeasureEnsemblePF_BB';
				case 3 % MeasureEnsemblePF_BB.DESCRIPTION
					prop_default = 'MeasureEnsemblePF_BB manages the basic functionalities to plot of a binodal bilayer group comparison figure.';
				case 4 % MeasureEnsemblePF_BB.TEMPLATE
					prop_default = Format.getFormatDefault(8, MeasureEnsemblePF_BB.getPropSettings(prop));
				case 5 % MeasureEnsemblePF_BB.ID
					prop_default = 'MeasureEnsemblePF_BB ID';
				case 6 % MeasureEnsemblePF_BB.LABEL
					prop_default = 'MeasureEnsemblePF_BB label';
				case 7 % MeasureEnsemblePF_BB.NOTES
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				case 40 % MeasureEnsemblePF_BB.NODES
					check = Format.checkFormat(12, value, MeasureEnsemblePF_BB.getPropSettings(prop));
				case 4 % MeasureEnsemblePF_BB.TEMPLATE
					check = Format.checkFormat(8, value, MeasureEnsemblePF_BB.getPropSettings(prop));
				otherwise
					if prop <= 39
