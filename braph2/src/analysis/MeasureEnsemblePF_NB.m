classdef MeasureEnsemblePF_NB < MeasureEnsemblePF
	...
	%
	% The list of MeasureEnsemblePF_NB properties is:
	...
	%  <strong>40</strong> <strong>NODE</strong> 	NODE (figure, scalar) is the node number of the nodal group comparison figure.
	%
	...
	methods (Static) % inspection
		function build = getBuild()
			...
			%
			% BUILD = MeasureEnsemblePF_NB.GETBUILD() returns the build of 'MeasureEnsemblePF_NB'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PF.GETBUILD() returns the build of the panel nodal bilayer group comparison figure PF.
			%  BUILD = Element.GETBUILD(PF) returns the build of 'PF'.
			%  BUILD = Element.GETBUILD('MeasureEnsemblePF_NB') returns the build of 'MeasureEnsemblePF_NB'.
			%
			% Note that the Element.GETBUILD(PF) and Element.GETBUILD('MeasureEnsemblePF_NB')
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'MeasureEnsemblePF_NB' }; %CET: Computational Efficiency Trick
		end
		...
		function check_out = existsProp(prop)
			...
			elseif ~check
				error( ...
					['BRAPH2' ':MeasureEnsemblePF_NB:' 'WrongInput'], ...
					['BRAPH2' ':MeasureEnsemblePF_NB:' 'WrongInput' '\n' ...
		...
		function check_out = existsTag(tag)
			...
			check = any(strcmp(tag, { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'ST_POSITION'  'H_TOOLBAR'  'H_TOOLS'  'H_AXES'  'ST_AXIS'  'LISTENER_ST_AXIS'  'ME'  'SETUP'  'H_AREA'  'ST_AREA'  'LISTENER_ST_AREA'  'H_LINE_M'  'ST_LINE_M'  'LISTENER_ST_LINE_M'  'H_TITLE'  'ST_TITLE'  'H_XLABEL'  'ST_XLABEL'  'H_YLABEL'  'ST_YLABEL'  'NODE' })); %CET: Computational Efficiency Trick
		...
		function prop = getPropProp(pointer)
			...
			if ischar(pointer)
				prop = find(strcmp(pointer, { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'ST_POSITION'  'H_TOOLBAR'  'H_TOOLS'  'H_AXES'  'ST_AXIS'  'LISTENER_ST_AXIS'  'ME'  'SETUP'  'H_AREA'  'ST_AREA'  'LISTENER_ST_AREA'  'H_LINE_M'  'ST_LINE_M'  'LISTENER_ST_LINE_M'  'H_TITLE'  'ST_TITLE'  'H_XLABEL'  'ST_XLABEL'  'H_YLABEL'  'ST_YLABEL'  'NODE' })); % tag = pointer %CET: Computational Efficiency Trick
			else % numeric
				prop = pointer;
			end
		end
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				measureensemblepf_nb_tag_list = { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'ST_POSITION'  'H_TOOLBAR'  'H_TOOLS'  'H_AXES'  'ST_AXIS'  'LISTENER_ST_AXIS'  'ME'  'SETUP'  'H_AREA'  'ST_AREA'  'LISTENER_ST_AREA'  'H_LINE_M'  'ST_LINE_M'  'LISTENER_ST_LINE_M'  'H_TITLE'  'ST_TITLE'  'H_XLABEL'  'ST_XLABEL'  'H_YLABEL'  'ST_YLABEL'  'NODE' };
				tag = measureensemblepf_nb_tag_list{pointer}; % prop = pointer
			end
		end
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			measureensemblepf_nb_category_list = { 1  1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  8  7  7  7  8  7  2  6  7  8  7  7  8  7  7  8  7  8  7  8  8 };
			prop_category = measureensemblepf_nb_category_list{prop};
		end
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			measureensemblepf_nb_format_list = { 2  2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  8  18  19  18  8  18  8  1  18  8  18  18  8  18  18  8  18  8  18  8  11 };
			prop_format = measureensemblepf_nb_format_list{prop};
		end
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 40 % MeasureEnsemblePF_NB.NODE
					prop_settings = Format.getFormatSettings(11);
				case 4 % MeasureEnsemblePF_NB.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 40 % MeasureEnsemblePF_NB.NODE
					prop_default = Format.getFormatDefault(11, MeasureEnsemblePF_NB.getPropSettings(prop));
				case 1 % MeasureEnsemblePF_NB.ELCLASS
					prop_default = 'MeasureEnsemblePF_NB';
				case 2 % MeasureEnsemblePF_NB.NAME
					prop_default = 'MeasureEnsemblePF_NB';
				case 3 % MeasureEnsemblePF_NB.DESCRIPTION
					prop_default = 'MeasureEnsemblePF_NB manages the basic functionalities to plot of a nodal bilayer group comparison figure.';
				case 4 % MeasureEnsemblePF_NB.TEMPLATE
					prop_default = Format.getFormatDefault(8, MeasureEnsemblePF_NB.getPropSettings(prop));
				case 5 % MeasureEnsemblePF_NB.ID
					prop_default = 'MeasureEnsemblePF_NB ID';
				case 6 % MeasureEnsemblePF_NB.LABEL
					prop_default = 'MeasureEnsemblePF_NB label';
				case 7 % MeasureEnsemblePF_NB.NOTES
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				case 40 % MeasureEnsemblePF_NB.NODE
					check = Format.checkFormat(11, value, MeasureEnsemblePF_NB.getPropSettings(prop));
				case 4 % MeasureEnsemblePF_NB.TEMPLATE
					check = Format.checkFormat(8, value, MeasureEnsemblePF_NB.getPropSettings(prop));
				otherwise
					if prop <= 39
