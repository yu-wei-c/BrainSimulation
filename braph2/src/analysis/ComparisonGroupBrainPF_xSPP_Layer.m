classdef ComparisonGroupBrainPF_xSPP_Layer < PanelProp
	...
	methods (Static) % inspection
		function build = getBuild()
			...
			%
			% BUILD = ComparisonGroupBrainPF_xSPP_Layer.GETBUILD() returns the build of 'ComparisonGroupBrainPF_xSPP_Layer'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PR.GETBUILD() returns the build of the panel property layer PR.
			%  BUILD = Element.GETBUILD(PR) returns the build of 'PR'.
			%  BUILD = Element.GETBUILD('ComparisonGroupBrainPF_xSPP_Layer') returns the build of 'ComparisonGroupBrainPF_xSPP_Layer'.
			%
			% Note that the Element.GETBUILD(PR) and Element.GETBUILD('ComparisonGroupBrainPF_xSPP_Layer')
