classdef ComparisonGroupBrainPF_BS < ComparisonGroupBrainPF
	...
	%
	% The list of ComparisonGroupBrainPF_BS properties is:
	%  <strong>1</strong> <strong>ELCLASS</strong> 	ELCLASS (constant, string) is the class of the  % % % .
	%  <strong>2</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the panel figure binodal superglobal group comparison on brain surface figure.
	%  <strong>3</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the panel figure binodal superglobal group comparison on brain surface figure.
	%  <strong>4</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the panel figure binodal superglobal group comparison on brain surface figure.
	%  <strong>5</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the panel figure binodal superglobal group comparison on brain surface figure.
	%  <strong>6</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the panel figure binodal superglobal group comparison on brain surface figure.
	%  <strong>7</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the panel figure binodal superglobal group comparison on brain surface figure.
	...
	methods (Static) % inspection
		function build = getBuild()
			%GETBUILD returns the build of the panel binodal superglobal group comparison on brain surface figure.
			%
			% BUILD = ComparisonGroupBrainPF_BS.GETBUILD() returns the build of 'ComparisonGroupBrainPF_BS'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PF.GETBUILD() returns the build of the panel binodal superglobal group comparison on brain surface figure PF.
			%  BUILD = Element.GETBUILD(PF) returns the build of 'PF'.
			%  BUILD = Element.GETBUILD('ComparisonGroupBrainPF_BS') returns the build of 'ComparisonGroupBrainPF_BS'.
			%
			% Note that the Element.GETBUILD(PF) and Element.GETBUILD('ComparisonGroupBrainPF_BS')
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'ComparisonGroupBrainPF_BS' }; %CET: Computational Efficiency Trick
		end
		...
		function check_out = existsProp(prop)
			...
			elseif ~check
				error( ...
					['BRAPH2' ':ComparisonGroupBrainPF_BS:' 'WrongInput'], ...
					['BRAPH2' ':ComparisonGroupBrainPF_BS:' 'WrongInput' '\n' ...
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			comparisongroupbrainpf_bs_category_list = { 1  1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  8  7  7  7  8  8  7  8  2  7  8  8  8  2  7  8  8  7  8  8  7  8  8  7  8  8  2  6  8 };
			prop_category = comparisongroupbrainpf_bs_category_list{prop};
		end
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			comparisongroupbrainpf_bs_format_list = { 2  2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  8  18  19  18  12  8  18  5  8  18  4  8  8  8  19  4  10  19  4  10  19  4  10  19  4  10  8  1  12 };
			prop_format = comparisongroupbrainpf_bs_format_list{prop};
		end
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 48 % ComparisonGroupBrainPF_BS.NODES
					prop_settings = Format.getFormatSettings(12);
				case 4 % ComparisonGroupBrainPF_BS.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 48 % ComparisonGroupBrainPF_BS.NODES
					prop_default = Format.getFormatDefault(12, ComparisonGroupBrainPF_BS.getPropSettings(prop));
				case 1 % ComparisonGroupBrainPF_BS.ELCLASS
					prop_default = 'ComparisonGroupBrainPF_BS';
				case 2 % ComparisonGroupBrainPF_BS.NAME
					prop_default = 'ComparisonGroupBrainPF_BS';
				case 3 % ComparisonGroupBrainPF_BS.DESCRIPTION
				...
				case 4 % ComparisonGroupBrainPF_BS.TEMPLATE
					prop_default = Format.getFormatDefault(8, ComparisonGroupBrainPF_BS.getPropSettings(prop));
				case 5 % ComparisonGroupBrainPF_BS.ID
					prop_default = 'ComparisonGroupBrainPF_BS ID';
				case 6 % ComparisonGroupBrainPF_BS.LABEL
					prop_default = 'ComparisonGroupBrainPF_BS label';
				case 7 % ComparisonGroupBrainPF_BS.NOTES
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				case 48 % ComparisonGroupBrainPF_BS.NODES
					check = Format.checkFormat(12, value, ComparisonGroupBrainPF_BS.getPropSettings(prop));
				case 4 % ComparisonGroupBrainPF_BS.TEMPLATE
					check = Format.checkFormat(8, value, ComparisonGroupBrainPF_BS.getPropSettings(prop));
				otherwise
					if prop <= 47
