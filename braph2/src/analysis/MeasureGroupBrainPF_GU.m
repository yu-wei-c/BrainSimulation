classdef MeasureGroupBrainPF_GU < MeasureGroupBrainPF
	...
	%
	% The list of MeasureGroupBrainPF_GU properties is:
	...
	methods (Static) % inspection
		function build = getBuild()
			...
			%
			% BUILD = MeasureGroupBrainPF_GU.GETBUILD() returns the build of 'MeasureGroupBrainPF_GU'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PF.GETBUILD() returns the build of the panel figure for global unilayer measure group brain PF.
			%  BUILD = Element.GETBUILD(PF) returns the build of 'PF'.
			%  BUILD = Element.GETBUILD('MeasureGroupBrainPF_GU') returns the build of 'MeasureGroupBrainPF_GU'.
			%
			% Note that the Element.GETBUILD(PF) and Element.GETBUILD('MeasureGroupBrainPF_GU')
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'MeasureGroupBrainPF_GU' }; %CET: Computational Efficiency Trick
		end
		...
		function check_out = existsProp(prop)
			...
			elseif ~check
				error( ...
					['BRAPH2' ':MeasureGroupBrainPF_GU:' 'WrongInput'], ...
					['BRAPH2' ':MeasureGroupBrainPF_GU:' 'WrongInput' '\n' ...
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			measuregroupbrainpf_gu_category_list = { 1  1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  8  7  7  7  8  8  7  8  2  7  8  8  8  2  7  8  8  7  8  8  7  8  8  7  8  8  2  6 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			measuregroupbrainpf_gu_format_list = { 2  2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  8  18  19  18  12  8  18  5  8  18  4  8  8  8  19  4  10  19  4  10  19  4  10  19  4  10  8  1 };
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 1 % MeasureGroupBrainPF_GU.ELCLASS
					prop_default = 'MeasureGroupBrainPF_GU';
				case 2 % MeasureGroupBrainPF_GU.NAME
					prop_default = 'Panel Figure for Measure Group Brain';
				case 3 % MeasureGroupBrainPF_GU.DESCRIPTION
				...
				case 4 % MeasureGroupBrainPF_GU.TEMPLATE
					prop_default = Format.getFormatDefault(8, MeasureGroupBrainPF_GU.getPropSettings(prop));
				case 5 % MeasureGroupBrainPF_GU.ID
					prop_default = 'MeasureGroupBrainPF_GU ID';
				case 6 % MeasureGroupBrainPF_GU.LABEL
					prop_default = 'MeasureGroupBrainPF_GU label';
				case 7 % MeasureGroupBrainPF_GU.NOTES
