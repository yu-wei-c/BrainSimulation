classdef ComparisonGroupPF_NxPP_Node < PanelProp
	...
	methods (Static) % inspection
		function build = getBuild()
			...
			%
			% BUILD = ComparisonGroupPF_NxPP_Node.GETBUILD() returns the build of 'ComparisonGroupPF_NxPP_Node'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PR.GETBUILD() returns the build of the panel property node PR.
			%  BUILD = Element.GETBUILD(PR) returns the build of 'PR'.
			%  BUILD = Element.GETBUILD('ComparisonGroupPF_NxPP_Node') returns the build of 'ComparisonGroupPF_NxPP_Node'.
			%
			% Note that the Element.GETBUILD(PR) and Element.GETBUILD('ComparisonGroupPF_NxPP_Node')
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				comparisongrouppf_nxpp_node_tag_list = { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'X_DRAW'  'UPDATE'  'REDRAW'  'EL'  'PROP'  'HEIGHT'  'TITLE'  'LABEL_TITLE'  'BUTTON_CB'  'GUI_CB'  'LISTENER_CB'  'BUTTON_CALC'  'BUTTON_DEL'  'LISTENER_SET'  'LISTENER_MEMORIZED'  'LISTENER_LOCKED'  'DROPDOWN' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			comparisongrouppf_nxpp_node_category_list = { 1  1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  6  6  6  4  4  9  9  7  7  4  7  7  7  7  7  7  7 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			comparisongrouppf_nxpp_node_format_list = { 2  2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  4  4  4  8  11  22  2  18  18  8  18  18  18  19  19  19  18 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 36 % ComparisonGroupPF_NxPP_Node.DROPDOWN
					prop_settings = Format.getFormatSettings(18);
				case 4 % ComparisonGroupPF_NxPP_Node.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 1 % ComparisonGroupPF_NxPP_Node.ELCLASS
					prop_default = 'ComparisonGroupPF_NxPP_Node';
				case 2 % ComparisonGroupPF_NxPP_Node.NAME
					prop_default = 'ComparisonGroupPF_NxPP_Node';
				case 3 % ComparisonGroupPF_NxPP_Node.DESCRIPTION
				...
				case 5 % ComparisonGroupPF_NxPP_Node.ID
					prop_default = 'ComparisonGroupPF_NxPP_Node ID';
				case 6 % ComparisonGroupPF_NxPP_Node.LABEL
					prop_default = 'ComparisonGroupPF_NxPP_Node label';
				case 7 % ComparisonGroupPF_NxPP_Node.NOTES
					prop_default = 'ComparisonGroupPF_NxPP_Node notes';
				case 23 % ComparisonGroupPF_NxPP_Node.EL
					prop_default = ComparisonGroupPF_NU();
				case 24 % ComparisonGroupPF_NxPP_Node.PROP
					prop_default = 46;
				case 25 % ComparisonGroupPF_NxPP_Node.HEIGHT
					prop_default = 48;
				otherwise
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pr, prop, varargin)
			...
			switch prop
				...
				case 20 % ComparisonGroupPF_NxPP_Node.X_DRAW
					value = calculateValue@PanelProp(pr, 20, varargin{:}); % also warning
					if value
					    pr.memorize('DROPDOWN')
					end
					
				case 21 % ComparisonGroupPF_NxPP_Node.UPDATE
				...
				case 22 % ComparisonGroupPF_NxPP_Node.REDRAW
				...
				case 18 % ComparisonGroupPF_NxPP_Node.DELETE
