classdef MeasureEnsemblePF_NS < MeasureEnsemblePF
	...
	%
	% The list of MeasureEnsemblePF_NS properties is:
	%  <strong>1</strong> <strong>ELCLASS</strong> 	ELCLASS (constant, string) is the class of the MeasureEnsemblePF_NS.
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'MeasureEnsemblePF_NS' }; %CET: Computational Efficiency Trick
		end
		...
		function check_out = existsProp(prop)
			...
			elseif ~check
				error( ...
					['BRAPH2' ':MeasureEnsemblePF_NS:' 'WrongInput'], ...
					['BRAPH2' ':MeasureEnsemblePF_NS:' 'WrongInput' '\n' ...
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				measureensemblepf_ns_tag_list = { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'ST_POSITION'  'H_TOOLBAR'  'H_TOOLS'  'H_AXES'  'ST_AXIS'  'LISTENER_ST_AXIS'  'ME'  'SETUP'  'H_AREA'  'ST_AREA'  'LISTENER_ST_AREA'  'H_LINE_M'  'ST_LINE_M'  'LISTENER_ST_LINE_M'  'H_TITLE'  'ST_TITLE'  'H_XLABEL'  'ST_XLABEL'  'H_YLABEL'  'ST_YLABEL'  'NODE' };
				tag = measureensemblepf_ns_tag_list{pointer}; % prop = pointer
			end
		end
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			measureensemblepf_ns_category_list = { 1  1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  8  7  7  7  8  7  2  6  7  8  7  7  8  7  7  8  7  8  7  8  8 };
			prop_category = measureensemblepf_ns_category_list{prop};
		end
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			measureensemblepf_ns_format_list = { 2  2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  8  18  19  18  8  18  8  1  18  8  18  18  8  18  18  8  18  8  18  8  11 };
			prop_format = measureensemblepf_ns_format_list{prop};
		end
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 40 % MeasureEnsemblePF_NS.NODE
					prop_settings = Format.getFormatSettings(11);
				case 4 % MeasureEnsemblePF_NS.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 40 % MeasureEnsemblePF_NS.NODE
					prop_default = 1;
				case 1 % MeasureEnsemblePF_NS.ELCLASS
					prop_default = 'MeasureEnsemblePF_NS';
				case 2 % MeasureEnsemblePF_NS.NAME
					prop_default = 'MeasureEnsemblePF_NS';
				case 3 % MeasureEnsemblePF_NS.DESCRIPTION
				...
				case 4 % MeasureEnsemblePF_NS.TEMPLATE
					prop_default = Format.getFormatDefault(8, MeasureEnsemblePF_NS.getPropSettings(prop));
				case 5 % MeasureEnsemblePF_NS.ID
					prop_default = 'MeasureEnsemblePF_NS ID';
				case 6 % MeasureEnsemblePF_NS.LABEL
					prop_default = 'MeasureEnsemblePF_NS label';
				case 7 % MeasureEnsemblePF_NS.NOTES
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				case 40 % MeasureEnsemblePF_NS.NODE
					check = Format.checkFormat(11, value, MeasureEnsemblePF_NS.getPropSettings(prop));
				case 4 % MeasureEnsemblePF_NS.TEMPLATE
					check = Format.checkFormat(8, value, MeasureEnsemblePF_NS.getPropSettings(prop));
				otherwise
					if prop <= 39
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pf, prop, varargin)
			...
			switch prop
				case 27 % MeasureEnsemblePF_NS.SETUP
					me = pf.get('ME');
