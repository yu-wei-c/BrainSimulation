classdef ComparisonEnsemblePF_BxPP_Nodes < PanelProp
	...
	%
	% The list of ComparisonEnsemblePF_BxPP_Nodes properties is:
	...
	methods (Static) % inspection
		function build = getBuild()
			...
			%
			% BUILD = ComparisonEnsemblePF_BxPP_Nodes.GETBUILD() returns the build of 'ComparisonEnsemblePF_BxPP_Nodes'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PR.GETBUILD() returns the build of the panel property node PR.
			%  BUILD = Element.GETBUILD(PR) returns the build of 'PR'.
			%  BUILD = Element.GETBUILD('ComparisonEnsemblePF_BxPP_Nodes') returns the build of 'ComparisonEnsemblePF_BxPP_Nodes'.
			%
			% Note that the Element.GETBUILD(PR) and Element.GETBUILD('ComparisonEnsemblePF_BxPP_Nodes')
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'ComparisonEnsemblePF_BxPP_Nodes' }; %CET: Computational Efficiency Trick
		end
		...
		function check_out = existsProp(prop)
			...
			elseif ~check
				error( ...
					['BRAPH2' ':ComparisonEnsemblePF_BxPP_Nodes:' 'WrongInput'], ...
					['BRAPH2' ':ComparisonEnsemblePF_BxPP_Nodes:' 'WrongInput' '\n' ...
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				comparisonensemblepf_bxpp_nodes_tag_list = { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'X_DRAW'  'UPDATE'  'REDRAW'  'EL'  'PROP'  'HEIGHT'  'TITLE'  'LABEL_TITLE'  'BUTTON_CB'  'GUI_CB'  'LISTENER_CB'  'BUTTON_CALC'  'BUTTON_DEL'  'LISTENER_SET'  'LISTENER_MEMORIZED'  'LISTENER_LOCKED'  'DROPDOWN_NODE1'  'DROPDOWN_NODE2' };
				tag = comparisonensemblepf_bxpp_nodes_tag_list{pointer}; % prop = pointer
			end
		end
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			comparisonensemblepf_bxpp_nodes_category_list = { 1  1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  6  6  6  4  4  9  9  7  7  4  7  7  7  7  7  7  7  7 };
			prop_category = comparisonensemblepf_bxpp_nodes_category_list{prop};
		end
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			comparisonensemblepf_bxpp_nodes_format_list = { 2  2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  4  4  4  8  11  22  2  18  18  8  18  18  18  19  19  19  18  18 };
			prop_format = comparisonensemblepf_bxpp_nodes_format_list{prop};
		end
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 36 % ComparisonEnsemblePF_BxPP_Nodes.DROPDOWN_NODE1
					prop_settings = Format.getFormatSettings(18);
				case 37 % ComparisonEnsemblePF_BxPP_Nodes.DROPDOWN_NODE2
					prop_settings = Format.getFormatSettings(18);
				case 4 % ComparisonEnsemblePF_BxPP_Nodes.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 36 % ComparisonEnsemblePF_BxPP_Nodes.DROPDOWN_NODE1
					prop_default = Format.getFormatDefault(18, ComparisonEnsemblePF_BxPP_Nodes.getPropSettings(prop));
				case 37 % ComparisonEnsemblePF_BxPP_Nodes.DROPDOWN_NODE2
					prop_default = Format.getFormatDefault(18, ComparisonEnsemblePF_BxPP_Nodes.getPropSettings(prop));
				case 1 % ComparisonEnsemblePF_BxPP_Nodes.ELCLASS
					prop_default = 'ComparisonEnsemblePF_BxPP_Nodes';
				case 2 % ComparisonEnsemblePF_BxPP_Nodes.NAME
					prop_default = 'ComparisonEnsemblePF_BxPP_Nodes';
				case 3 % ComparisonEnsemblePF_BxPP_Nodes.DESCRIPTION
				...
				case 4 % ComparisonEnsemblePF_BxPP_Nodes.TEMPLATE
					prop_default = Format.getFormatDefault(8, ComparisonEnsemblePF_BxPP_Nodes.getPropSettings(prop));
				case 5 % ComparisonEnsemblePF_BxPP_Nodes.ID
					prop_default = 'ComparisonEnsemblePF_BxPP_Nodes ID';
				case 6 % ComparisonEnsemblePF_BxPP_Nodes.LABEL
					prop_default = 'ComparisonEnsemblePF_BxPP_Nodes label';
				case 7 % ComparisonEnsemblePF_BxPP_Nodes.NOTES
					prop_default = 'ComparisonEnsemblePF_BxPP_Nodes notes';
				case 23 % ComparisonEnsemblePF_BxPP_Nodes.EL
					prop_default = ComparisonEnsemblePF_BU();
				case 24 % ComparisonEnsemblePF_BxPP_Nodes.PROP
					prop_default = 46;
				case 25 % ComparisonEnsemblePF_BxPP_Nodes.HEIGHT
					prop_default = 48;
				otherwise
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				case 36 % ComparisonEnsemblePF_BxPP_Nodes.DROPDOWN_NODE1
					check = Format.checkFormat(18, value, ComparisonEnsemblePF_BxPP_Nodes.getPropSettings(prop));
				case 37 % ComparisonEnsemblePF_BxPP_Nodes.DROPDOWN_NODE2
					check = Format.checkFormat(18, value, ComparisonEnsemblePF_BxPP_Nodes.getPropSettings(prop));
				case 4 % ComparisonEnsemblePF_BxPP_Nodes.TEMPLATE
					check = Format.checkFormat(8, value, ComparisonEnsemblePF_BxPP_Nodes.getPropSettings(prop));
				otherwise
					if prop <= 35
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pr, prop, varargin)
			...
			switch prop
				...
				case 20 % ComparisonEnsemblePF_BxPP_Nodes.X_DRAW
				...
				case 21 % ComparisonEnsemblePF_BxPP_Nodes.UPDATE
				...
				case 22 % ComparisonEnsemblePF_BxPP_Nodes.REDRAW
				...
				case 18 % ComparisonEnsemblePF_BxPP_Nodes.DELETE
