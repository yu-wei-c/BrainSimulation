classdef ComparisonGroupBrainPF_NU < ComparisonGroupBrainPF
	...
	methods (Static) % inspection
		function build = getBuild()
			%GETBUILD returns the build of the panel nodal unilayer group comparison on brain surface figure.
			%
			% BUILD = ComparisonGroupBrainPF_NU.GETBUILD() returns the build of 'ComparisonGroupBrainPF_NU'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PF.GETBUILD() returns the build of the panel nodal unilayer group comparison on brain surface figure PF.
			%  BUILD = Element.GETBUILD(PF) returns the build of 'PF'.
			%  BUILD = Element.GETBUILD('ComparisonGroupBrainPF_NU') returns the build of 'ComparisonGroupBrainPF_NU'.
			%
			% Note that the Element.GETBUILD(PF) and Element.GETBUILD('ComparisonGroupBrainPF_NU')
